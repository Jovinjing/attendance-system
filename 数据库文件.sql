...
CREATE TABLE `signin`  (
  `id` int(0) NOT NULL AUTO_INCREMENT COMMENT '编码',
  `signin_id` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '请假编号',
  ...
  `day_num` int(0) NULL DEFAULT NULL COMMENT '天数',
  ...
  `update_time` timestamp(0) NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 18 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '请假表' ROW_FORMAT = Compact;
...
CREATE TABLE `sys_course`  (
  ...
  `hour` int(0) NULL DEFAULT NULL COMMENT '学时',
  `create_time` timestamp(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  `update_time` timestamp(0) NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `sys_leave`  (
  ...
  `update_time` timestamp(0) NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 14 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '请假表' ROW_FORMAT = Compact;
...
CREATE TABLE `sys_rest`  (
  `id` int(0) NOT NULL AUTO_INCREMENT COMMENT '编码',
  `rest_id` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '请假编号',
  `course_id` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '课程编码',
  `reason` varchar(150) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '请假理由',
  `day_num` int(0) NULL DEFAULT NULL COMMENT '天数',
  `stu_no` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '学号',
  ...
  `update_time` timestamp(0) NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 16 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '请假表' ROW_FORMAT = Compact;
...
-- ----------------------------
INSERT INTO `sys_student` VALUES (1, '201809512326', 'DSJ-18RJ01', '工具人', 1, '梧州学院', '17683864164', '工具人爸爸', '13578542365', '2021-05-08 16:27:59', '2022-05-07 19:02:34');
INSERT INTO `sys_student` VALUES (2, '201809512327', 'DSJ-18RJ01', '风飒飒', 1, '梧州学院', '14586255568', '风飒飒爸爸', '13784525242', '2021-05-08 16:27:59', '2022-05-07 19:02:34');
INSERT INTO `sys_student` VALUES (3, '201809512328', 'DSJ-18RJ01', '张佳辉', 1, '梧州学院', '12345686453', '张佳辉妈妈', '12854282528', '2021-05-08 16:27:59', '2022-05-07 19:02:34');
INSERT INTO `sys_student` VALUES (4, '201809512340', 'DSJ-18RJ01', '艾丽丝', 0, '梧州学院', '15864562345', '艾丽丝爸爸', '17953574575', '2021-05-08 16:27:59', '2021-05-08 16:27:59');
INSERT INTO `sys_student` VALUES (5, '201909512328', 'DSJ-18RJ01', '傅凌湘', 0, '梧州学院', '13868653453', '傅凌湘妈妈', '14852756868', '2021-05-08 16:27:59', '2022-05-07 19:02:34');
INSERT INTO `sys_student` VALUES (6, '201909512330', 'DSJ-18RJ01', '弗朗叙', 1, '梧州学院', '18755354686', '弗朗叙爸爸', '15825282285', '2021-05-08 16:27:59', '2022-05-07 19:02:34');
INSERT INTO `sys_student` VALUES (7, '测试', 'DSJ-18RJ01', '测试', 1, '测试', '测试', '测试', '测试', '2021-05-09 12:35:25', '2022-05-07 19:02:34');

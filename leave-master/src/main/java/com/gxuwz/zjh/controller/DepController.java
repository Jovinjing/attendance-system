...
public class DepController  extends AbstractController{
    ...
    public ModelAndView findDepById(ModelAndView modelAndView, Department department, Integer pageNumber,
        ...
        page.setSize(6);
        // 调用分页查询方法！!
        IPage<Department> departmentIPage = iDepService.selectPage(page, wrapper);
        // 存放一个数组用来让foreach遍历
    ...
    public String addEditDep(Department department, HttpServletRequest request) {
        Department department1 = iDepService.findById(department);
        ...
        if(department1 == null){
            ...
            try {
                iDepService.addObject(department);
        ...
        if(department1 != null){
            ...
            try {
                iDepService.updateById(department);
    ...
    public String deleteDepById(HttpServletRequest request, String depId) {
        ...
        try {
            iDepService.deleteById(department);

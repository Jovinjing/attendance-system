...
public class InstructorController  extends AbstractController{
    ...
    public ModelAndView findInstructorById(ModelAndView modelAndView, Instructor instructor, Integer pageNumber,
        ...
        page.setSize(6);
        // 调用分页查询方法！!
        IPage<Instructor> instructorIPage = iInstructorService.selectPage(page, wrapper);
        // 存放一个数组用来让foreach遍历
    ...
    public String addEditInstructor(Instructor instructor, HttpServletRequest request) {
        Instructor instructor1 = iInstructorService.findById(instructor);
        ...
        if(instructor1 == null){
            ...
            try {
                iInstructorService.addObject(instructor);
        ...
        if(instructor1 != null){
            ...
            try {
                iInstructorService.updateById(instructor);
    ...
    public String deleteInstructorById(HttpServletRequest request, String instId) {
        ...
        try {
            iInstructorService.deleteById(instructor);

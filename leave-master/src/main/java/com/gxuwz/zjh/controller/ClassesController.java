...
public class ClassesController extends AbstractController{
    ...
    public ModelAndView findClassesById(ModelAndView modelAndView, Classes classes, Integer pageNumber,
        ...
        page.setSize(6);
        // 调用分页查询方法！!
        IPage<Classes> classesIPage = iClassesService.selectPage(page, wrapper);
        // 存放一个数组用来让foreach遍历
    ...
    public String addEditClasses(Classes classes, HttpServletRequest request) {
        Classes classes1 = iClassesService.findById(classes);
        ...
        if(classes1 == null){
            ...
            try {
                iClassesService.addObject(classes);
    ...
    public String deleteClassesById(HttpServletRequest request, String classId) {
        ...
        try {
            iClassesService.deleteById(classes);
